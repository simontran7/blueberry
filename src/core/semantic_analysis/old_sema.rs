// Old, pre-rewrite semantic-analysis code, kept for reference only.
// Everything in this file is inert (commented out); nothing here is compiled.

// ===== formerly semantic_analysis/semantic_analyzer.rs =====
// (the old fused name-resolution + type-inference analyzer)
...
// ===== formerly semantic_analysis/semantic_diagnostic.rs =====
...
// ===== formerly semantic_analysis/type_checking/constraints.rs =====
/* Being redesigned from scratch alongside the new HIR -- kept here for
reference during the rewrite. */
/*
use crate::core::common::span::Span;
...
// ===== formerly semantic_analysis/type_checking/unification_table.rs =====
/* Being redesigned from scratch alongside the new HIR -- kept here for
reference during the rewrite. */
/*
...
// ===== formerly the dead half of semantic_analysis/name_resolution/symbol_table.rs =====
// (the live Resolution<'db> enum stayed behind in symbol_table.rs)
/*
use std::collections::HashMap;
